...
const SubHomeScreen = () => {
  ...
  const navigation = useNavigation();
	const homeButtons = [
		 { buttonId: 'AlphabetEng', title:'Alphabet', colors: ['#ed365b', '#f592a6'], brdColor: '#ab102f'},
		// { buttonId: 'FindLetter', title:'Найди букву', colors: ['#ef6325', '#f79f60'], brdColor: '#c9300f'},
    // { buttonId: 'English', title:'Английский язык', colors: ['#57C785', '#33F263'], brdColor: '#238b3e'},
  ...
  return (
    ...
    <Image
      ...
      style={{width:350, height:55, marginTop:20, marginBottom:60, alignSelf:'center', borderWidth:0}}
      />
